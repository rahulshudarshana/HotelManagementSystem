...
CREATE TABLE CheckIns (
    ...
    GuestID           INT           NOT NULL,
    RoomID            INT           NOT NULL,
    ActualCheckInDate DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    NumberOfGuests    INT           NOT NULL,
...
CREATE TABLE CheckOuts (
    ...
    GuestID            INT           NOT NULL,
    RoomID             INT           NOT NULL,
    ActualCheckOutDate DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP,
